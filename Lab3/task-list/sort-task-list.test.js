...
describe("sorting a task list", function () {
  it("should sort tasks by created date", function () {
  ...
  describe("when sorting by completed date", function () {
    it("should return 0 when neither task is completed", function () {
      const taskA = tasklist.Task("1", "Task A");
      const taskB = tasklist.Task("2", "Task B");
    ...
    it("should return -1 when Task B is incomplete but Task A is completed", function () {
      const taskA = tasklist.Task("1", "Task A");
      const taskB = tasklist.Task("2", "Task B");
    ...
    it("should return 1 when Task A is incomplete but Task B is completed", function () {
      const taskA = tasklist.Task("1", "Task A");
      const taskB = tasklist.Task("2", "Task B");
    ...
    it("should sort tasks properly when both tasks have completed dates", function () {
      const taskA = tasklist.Task("1", "Task A");
      const taskB = tasklist.Task("2", "Task B");
